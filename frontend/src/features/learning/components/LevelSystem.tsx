...
//     return (completedRequired / requiredProblems.length) * 100;
//   };
...
//     const averageProgress = topicProgresses.reduce((a: number, b: number) => a + b, 0) / topicProgresses.length;
...
//                 <div>
//                   <h3 className="text-2xl font-bold">Level {level.order}</h3>
//                   <p className="text-muted-foreground">{level.description}</p>
//                 </div>
//                 <ProgressBar progress={calculateLevelProgress(level)} />
//               </div>
